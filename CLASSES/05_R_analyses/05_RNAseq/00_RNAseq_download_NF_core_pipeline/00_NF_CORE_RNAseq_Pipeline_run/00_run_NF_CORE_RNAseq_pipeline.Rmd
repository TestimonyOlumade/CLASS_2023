...
```
# 'slurm' is the language through which nextflow talks to your server. 
# it will be 'local', if you are running on your PC
...
# NEXTFLOW.CONFIG
# use nano to create the config file and paste the chunk below
