...
# The md5sum is a hash attached to every experiment file on ENCODE to verify the integrity of the file.
# A change to the file (through editing, faulty file transfer, disk error, etc) will result in a change in its md5sum 
