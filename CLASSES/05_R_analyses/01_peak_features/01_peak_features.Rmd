...
# output is the file path to all the unique peak files in the consensus_peak_files.
...
```
 # this will help you grab just the gene name from the filepath by deleting the entire path before the dbp name
 # and then everything after the dbp name.
...
# here, we are basically asking, what subsets of the gencode_genes, under the gene_type match to "protein coding"
...
# this simply creates a new column called 'peaks_overlapping_promoters' in the 'num_peaks_df' file and inputs the
# row sums in that column as output.
