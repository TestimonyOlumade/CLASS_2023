...
# This command will come in handy when you want to see how many overlaps there are in your data, or unique enteries, etc.
...
```
In one line, the code is:
Pol2_peak1 <- Pol2_peak1 %>% mutate(peak_width = end - start)

# That function will create a new column with the peak width at the end of the table.
