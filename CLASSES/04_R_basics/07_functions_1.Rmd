...
## Note that when documenting functions, you always need to add the "#'" sign so that R understands
 ## that you want to document some note to the function
## Description - introduces the description of the function
## param - (parameter) and explains what the parameters are.
...
# The function above will only return the object after the '/' in the string that it is given as input
